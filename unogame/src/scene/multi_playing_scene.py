...
class Cards(pygame.sprite.Sprite):
    ...
    def __init__(self, user_id: int, x, y, networking: MultiNetworking, *groups: AbstractGroup,
...
class GameCards(pygame.sprite.Sprite):
    def __init__(self, networking: MultiNetworking, x, y, *groups: AbstractGroup):
        super().__init__(*groups)
        self.networking = networking
...
class ColorChooser(pygame.sprite.Sprite):
    def __init__(self, x, y, networking: MultiNetworking, *groups: AbstractGroup):
        super().__init__(*groups)
        self.networking = networking
...
class CardGiver(pygame.sprite.Sprite):
    def __init__(self, x: int, y: int, networking: MultiNetworking, *groups: AbstractGroup):
        super().__init__(*groups)
        self.networking = networking
...
class PlayingScene(Scene):
    ...
    def __init__(self, screen, gui_manager, params=None, server=None):  # , image_loader: ImageLoader):
        ...
        self.networking = MultiNetworking()
