...
from states import MultiPasswordState
...
class MultiPasswordScene(Scene):
        ...
        if event.type == pygame.USEREVENT:
            if event.user_type == pygame_gui.UI_BUTTON_PRESSED:
                ...
                if event.ui_element == self.move_scene_buttons[1]:
                    self.state.move_scene(scene_name.MULTI_ROBBY_SCENE, self.password)

    def draw(self):
        font = pygame.font.SysFont('arial', 30)
        text_title = font.render("Set Password", True, (255, 255, 255))
        ...
        self.screen.blit(text_title, vp(550, 180))
